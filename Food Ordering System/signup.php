<?php include('partial-front/menu.php'); ?>
 ...
 <div class="all-page-title page-breadcrumb">
	...
	<div class="contact-box ">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
      <table cellpadding="10" cellspacing="12" talign="left	">
 ...
 <td> <input type="email" name="email" value="" placeholder="Enter Your Email Address" required="" style="padding: 10px; width: 300%">  <br> </td>
      ...
      <tr>   
<td talign="center"> <input type="submit" name="sb" value="Registration Now" style="color:red; background: lightgreen; font-size: 1.3em; font-family: times new roman">  <br> </td>
   </tr>
