...
<div class="main-content">
        ...
        <table class="tbl-30">
            ...
            <tr>
                ...
                <b>  <?php echo $customer_address; ?></b>
                    <!-- <input name="customer_address" cols="30" rows="5"><?php echo $customer_address; ?></input> -->
                    <input type="hidden" name="customer_address" cols="30" rows="5" value="<?php echo $customer_address; ?>"></input>
                </td>
            </tr>
    ...
    <?php 
        ...
        if(isset($_POST['submit']))
        {
            ...
            {
                //Updated
                $_SESSION['update'] = "<div class='bg-success'>Order Updated Successfully.</div>";
                header('location:'.SITE_URL.'staff/index.php');
            }
            else
            {
                //Failed to Update
                $_SESSION['update'] = "<div class='bg-danger'>Failed to Update Order.</div>";
                header('location:'.SITE_URL.'staff/index.php');
            }
        }
    ?>
